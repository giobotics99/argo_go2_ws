...
struct UdpFrame_
{
  ...
  _header_type header;
  using _packets_type =
    std::vector<hesai_ros_driver::msg::UdpPacket_<ContainerAllocator>, typename ContainerAllocator::template rebind<hesai_ros_driver::msg::UdpPacket_<ContainerAllocator>>::other>;
  ...
  Type & set__packets(
    const std::vector<hesai_ros_driver::msg::UdpPacket_<ContainerAllocator>, typename ContainerAllocator::template rebind<hesai_ros_driver::msg::UdpPacket_<ContainerAllocator>>::other> & _arg)
  {
    this->packets = _arg;
    return *this;
  }
