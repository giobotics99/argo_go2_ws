...
static const _Ptp_type_support_symbol_names_t _Ptp_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hesai_ros_driver, msg, Ptp)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hesai_ros_driver, msg, Ptp)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hesai_ros_driver, msg, Ptp)() {
  return &::hesai_ros_driver::msg::rosidl_typesupport_c::Ptp_message_type_support_handle;
}
